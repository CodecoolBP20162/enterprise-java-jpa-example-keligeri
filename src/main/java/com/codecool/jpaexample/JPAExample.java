...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1,
                address, Arrays.asList("123456", "123457"), classBp2);
        ...
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2,
                address, Arrays.asList("06309874568", "0630594"), classBp2);
